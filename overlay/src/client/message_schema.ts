...
function parse_as_Union_of_Literal_of__quote_precomputed_quote__endof_0None_endof_(value: JsonValue): 'precomputed' | undefined | Error{
...
function parse_as_Literal_of__quote_http_quote_0_quote_https_quote_0_quote_file_quote_0_quote_memory_quote__endof_(value: JsonValue): 'http' | 'https' | 'file' | 'memory' | Error{
    const tmp_0 = parse_as_str(value)
...
function parse_as_Mapping_of_str0str_endof_(value: JsonValue): { [key: string]: string } | Error{
    const valueObj = ensureJsonObject(value);if(valueObj instanceof Error){
        return valueObj
    }
...
function parse_as_Union_of_Mapping_of_str0str_endof_0None_endof_(value: JsonValue): { [key: string]: string } | undefined | Error{
...
function parse_as_UrlDto(value: JsonValue): UrlDto | Error{
    ...
    const temp_datascheme = parse_as_Union_of_Literal_of__quote_precomputed_quote__endof_0None_endof_(valueObject.datascheme)
    if(temp_datascheme instanceof Error){ return temp_datascheme; }
    const temp_protocol = parse_as_Literal_of__quote_http_quote_0_quote_https_quote_0_quote_file_quote_0_quote_memory_quote__endof_(valueObject.protocol)
...
function parse_as_BucketFSDto(value: JsonValue): BucketFSDto | Error{
    ...
    const temp_prefix = parse_as_str(valueObject.prefix)
    if(temp_prefix instanceof Error){ return temp_prefix; }
...
function parse_as_DataSourceDto(value: JsonValue): DataSourceDto | Error{
    const valueObject = ensureJsonObject(value);
    if(valueObject instanceof Error){
        return valueObject;
    }
...
// Automatically generated via DataTransferObject for DataSourceDto
// Do not edit!
export class DataSourceDto {
    ...
    public toJsonValue(): JsonObject{
        return {
            ...
            spatial_resolution: [this.spatial_resolution[0],
this.spatial_resolution[1],
this.spatial_resolution[2]],
        }
    }
    public static fromJsonValue(value: JsonValue): DataSourceDto | Error{
        return parse_as_DataSourceDto(value)    }
}

function parse_as_Union_of_OsfsDto0HttpFsDto0BucketFSDto_endof_(value: JsonValue): OsfsDto | HttpFsDto | BucketFSDto | Error{
...
function parse_as_N5DataSourceDto(value: JsonValue): N5DataSourceDto | Error{
    ...
    const temp_path = parse_as_str(valueObject.path)
    if(temp_path instanceof Error){ return temp_path; }
    const temp_location = parse_as_Point5DDto(valueObject.location)
    if(temp_location instanceof Error){ return temp_location; }
    const temp_spatial_resolution = parse_as_Tuple_of_int0int0int_endof_(valueObject.spatial_resolution)
    if(temp_spatial_resolution instanceof Error){ return temp_spatial_resolution; }
...
export class N5DataSourceDto {
    ...
    public toJsonValue(): JsonObject{
        return {
            ...
            path: this.path,
            location: this.location.toJsonValue(),
            spatial_resolution: [this.spatial_resolution[0],
this.spatial_resolution[1],
this.spatial_resolution[2]],
        }
...
function parse_as_Literal_of__quote_uint8_quote_0_quote_uint16_quote_0_quote_uint32_quote_0_quote_uint64_quote_0_quote_float32_quote__endof_(value: JsonValue): 'uint8' | 'uint16' | 'uint32' | 'uint64' | 'float32' | Error{
    const tmp_0 = parse_as_str(value)
...
function parse_as_DataSinkDto(value: JsonValue): DataSinkDto | Error{
    const valueObject = ensureJsonObject(value);
    if(valueObject instanceof Error){
        return valueObject;
    }
    ...
    const temp_interval = parse_as_Interval5DDto(valueObject.interval)
    if(temp_interval instanceof Error){ return temp_interval; }
    const temp_dtype = parse_as_Literal_of__quote_uint8_quote_0_quote_uint16_quote_0_quote_uint32_quote_0_quote_uint64_quote_0_quote_float32_quote__endof_(valueObject.dtype)
    if(temp_dtype instanceof Error){ return temp_dtype; }
    return new DataSinkDto({
        tile_shape: temp_tile_shape,
        interval: temp_interval,
        dtype: temp_dtype,
    })
}
// Automatically generated via DataTransferObject for DataSinkDto
// Do not edit!
export class DataSinkDto {
    ...
    public static fromJsonValue(value: JsonValue): DataSinkDto | Error{
        return parse_as_DataSinkDto(value)    }
}

function parse_as_FsDataSinkDto(value: JsonValue): FsDataSinkDto | Error{
    const valueObject = ensureJsonObject(value);
    if(valueObject instanceof Error){
        return valueObject;
    }
...
// Automatically generated via DataTransferObject for FsDataSinkDto
// Do not edit!
export class FsDataSinkDto {
    public tile_shape: Shape5DDto;
    public interval: Interval5DDto;
    public dtype: 'uint8' | 'uint16' | 'uint32' | 'uint64' | 'float32';
    public filesystem: OsfsDto | HttpFsDto | BucketFSDto;
    ...
    public static fromJsonValue(value: JsonValue): FsDataSinkDto | Error{
        return parse_as_FsDataSinkDto(value)    }
}
...
function parse_as_Tuple_of_Tuple_of_int0int0int_endof_0_varlen__endof_(value: JsonValue): Array<[number,number,number]> | Error{
...
function parse_as_PixelAnnotationDto(value: JsonValue): PixelAnnotationDto | Error{
    ...
    const temp_raw_data = parse_as_DataSourceDto(valueObject.raw_data)
...
export class PixelAnnotationDto {
    ...
    public toJsonValue(): JsonObject{
        return {
            raw_data: this.raw_data.toJsonValue(),
            points: this.points.map(item => [item[0],
item[1],
item[2]]),
        }
    }
...
export class RecolorLabelParams {
    ...
    constructor(params: {
        ...
        this.label_name = params.label_name;
        this.new_color = params.new_color;
    }
    public toJsonValue(): JsonObject{
        return {
...
export class AddPixelAnnotationParams {
    ...
    constructor(params: {
        ...
        this.label_name = params.label_name;
        this.pixel_annotation = params.pixel_annotation;
    }
    public toJsonValue(): JsonObject{
        return {
            label_name: this.label_name,
...
function parse_as_Tuple_of_DataSourceDto0_varlen__endof_(value: JsonValue): Array<DataSourceDto> | Error{
    const arr = ensureJsonArray(value);
    if(arr instanceof Error){    return arr
    }
    const out: Array<DataSourceDto> = []
    for(let item of arr){
        let parsed_item = parse_as_DataSourceDto(item);
        if(parsed_item instanceof Error){        return parsed_item;    }
        out.push(parsed_item);
    }
    return out;
...
function parse_as_RawDataViewDto(value: JsonValue): RawDataViewDto | Error{
    ...
    const temp_url = parse_as_UrlDto(valueObject.url)
    if(temp_url instanceof Error){ return temp_url; }
    const temp_datasources = parse_as_Tuple_of_DataSourceDto0_varlen__endof_(valueObject.datasources)
...
export class RawDataViewDto {
    public name: string;
    public url: UrlDto;
    public datasources: Array<DataSourceDto>;
    constructor(params: {
        name: string,
        url: UrlDto,
    ...
    public toJsonValue(): JsonObject{
        return {
            name: this.name,
            url: this.url.toJsonValue(),
            datasources: this.datasources.map(item => item.toJsonValue()),
        }
    }
...
function parse_as_StrippedPrecomputedViewDto(value: JsonValue): StrippedPrecomputedViewDto | Error{
    ...
    const temp_url = parse_as_UrlDto(valueObject.url)
    if(temp_url instanceof Error){ return temp_url; }
    const temp_datasource = parse_as_DataSourceDto(valueObject.datasource)
...
export class StrippedPrecomputedViewDto {
    ...
    public toJsonValue(): JsonObject{
        return {
            name: this.name,
            url: this.url.toJsonValue(),
            datasource: this.datasource.toJsonValue(),
        }
    }
...
function parse_as_Union_of_RawDataViewDto0StrippedPrecomputedViewDto0FailedViewDto0UnsupportedDatasetViewDto_endof_(value: JsonValue): RawDataViewDto | StrippedPrecomputedViewDto | FailedViewDto | UnsupportedDatasetViewDto | Error{
    ...
    return Error(`Could not parse ${JSON.stringify(value)} into RawDataViewDto | StrippedPrecomputedViewDto | FailedViewDto | UnsupportedDatasetViewDto`)
}
function parse_as_Tuple_of_Union_of_RawDataViewDto0StrippedPrecomputedViewDto0FailedViewDto0UnsupportedDatasetViewDto_endof_0_varlen__endof_(value: JsonValue): Array<RawDataViewDto | StrippedPrecomputedViewDto | FailedViewDto | UnsupportedDatasetViewDto> | Error{
    const arr = ensureJsonArray(value);
    if(arr instanceof Error){    return arr
    }
    const out: Array<RawDataViewDto | StrippedPrecomputedViewDto | FailedViewDto | UnsupportedDatasetViewDto> = []
    for(let item of arr){
        let parsed_item = parse_as_Union_of_RawDataViewDto0StrippedPrecomputedViewDto0FailedViewDto0UnsupportedDatasetViewDto_endof_(item);
        if(parsed_item instanceof Error){        return parsed_item;    }
        out.push(parsed_item);
    }
    return out;
...
function parse_as_ViewerAppletStateDto(value: JsonValue): ViewerAppletStateDto | Error{
    ...
    const temp_data_views = parse_as_Tuple_of_Union_of_RawDataViewDto0StrippedPrecomputedViewDto0FailedViewDto0UnsupportedDatasetViewDto_endof_0_varlen__endof_(valueObject.data_views)
...
export class ViewerAppletStateDto {
    ...
    constructor(params: {
        ...
        this.frontend_timestamp = params.frontend_timestamp;
...
function parse_as_Literal_of__quote_pending_quote_0_quote_running_quote_0_quote_cancelled_quote_0_quote_failed_quote_0_quote_succeeded_quote__endof_(value: JsonValue): 'pending' | 'running' | 'cancelled' | 'failed' | 'succeeded' | Error{
    const tmp_0 = parse_as_str(value)
...
function parse_as_JobDto(value: JsonValue): JobDto | Error{
    ...
    const temp_status = parse_as_Literal_of__quote_pending_quote_0_quote_running_quote_0_quote_cancelled_quote_0_quote_failed_quote_0_quote_succeeded_quote__endof_(valueObject.status)
...
function parse_as_ExportJobDto(value: JsonValue): ExportJobDto | Error{
    ...
    const temp_error_message = parse_as_Union_of_str0None_endof_(valueObject.error_message)
    if(temp_error_message instanceof Error){ return temp_error_message; }
    const temp_datasink = parse_as_PrecomputedChunksSinkDto(valueObject.datasink)
...
export class ExportJobDto {
    ...
    public num_completed_steps: number;
    public error_message: string | undefined;
    public datasink: PrecomputedChunksSinkDto;
    constructor(params: {
        name: string,
        num_args: number | undefined,
        uuid: string,
    ...
    public toJsonValue(): JsonObject{
        return {
            ...
            num_completed_steps: this.num_completed_steps,
            error_message: toJsonValue(this.error_message),
            datasink: this.datasink.toJsonValue(),
        }
    }
...
function parse_as_Union_of_ExportJobDto0OpenDatasinkJobDto_endof_(value: JsonValue): ExportJobDto | OpenDatasinkJobDto | Error{
...
function parse_as_Tuple_of_Union_of_ExportJobDto0OpenDatasinkJobDto_endof_0_varlen__endof_(value: JsonValue): Array<ExportJobDto | OpenDatasinkJobDto> | Error{
    const arr = ensureJsonArray(value);
    if(arr instanceof Error){    return arr
    }
...
function parse_as_Union_of_Tuple_of_LabelHeaderDto0_varlen__endof_0None_endof_(value: JsonValue): Array<LabelHeaderDto> | undefined | Error{
...
function parse_as_Union_of_Tuple_of_DataSourceDto0_varlen__endof_0None_endof_(value: JsonValue): Array<DataSourceDto> | undefined | Error{
    const parsed_option_0 = parse_as_Tuple_of_DataSourceDto0_varlen__endof_(value)
    if(!(parsed_option_0 instanceof Error)){
        return parsed_option_0;
    }
    const parsed_option_1 = parse_as_None(value)
    ...
    return Error(`Could not parse ${JSON.stringify(value)} into Array<DataSourceDto> | undefined`)
}
function parse_as_PixelClassificationExportAppletStateDto(value: JsonValue): PixelClassificationExportAppletStateDto | Error{
    const valueObject = ensureJsonObject(value);
    if(valueObject instanceof Error){
        return valueObject;
    }
    ...
    const temp_populated_labels = parse_as_Union_of_Tuple_of_LabelHeaderDto0_varlen__endof_0None_endof_(valueObject.populated_labels)
    if(temp_populated_labels instanceof Error){ return temp_populated_labels; }
    const temp_datasource_suggestions = parse_as_Union_of_Tuple_of_DataSourceDto0_varlen__endof_0None_endof_(valueObject.datasource_suggestions)
...
export class PixelClassificationExportAppletStateDto {
    ...
    public datasource_suggestions: Array<DataSourceDto> | undefined;
    constructor(params: {
        jobs: Array<ExportJobDto | OpenDatasinkJobDto>,
        populated_labels: Array<LabelHeaderDto> | undefined,
        datasource_suggestions: Array<DataSourceDto> | undefined,
    }) {
        this.jobs = params.jobs;
        this.populated_labels = params.populated_labels;
...
function parse_as_Literal_of__quote_x_quote_0_quote_y_quote_0_quote_z_quote__endof_(value: JsonValue): 'x' | 'y' | 'z' | Error{
    const tmp_0 = parse_as_str(value)
...
function parse_as_Union_of_Literal_of__quote_x_quote_0_quote_y_quote_0_quote_z_quote__endof_0None_endof_(value: JsonValue): 'x' | 'y' | 'z' | undefined | Error{
...
function parse_as_Literal_of__quote_GaussianSmoothing_quote_0_quote_LaplacianofGaussian_quote_0_quote_GaussianGradientMagnitude_quote_0_quote_DifferenceofGaussians_quote_0_quote_StructureTensorEigenvalues_quote_0_quote_HessianofGaussianEigenvalues_quote__endof_(value: JsonValue): 'Gaussian Smoothing' | 'Laplacian of Gaussian' | 'Gaussian Gradient Magnitude' | 'Difference of Gaussians' | 'Structure Tensor Eigenvalues' | 'Hessian of Gaussian Eigenvalues' | Error{
    ...
    return Error(`Could not parse ${value} as 'Gaussian Smoothing' | 'Laplacian of Gaussian' | 'Gaussian Gradient Magnitude' | 'Difference of Gaussians' | 'Structure Tensor Eigenvalues' | 'Hessian of Gaussian Eigenvalues'`)
}
function parse_as_IlpFeatureExtractorDto(value: JsonValue): IlpFeatureExtractorDto | Error{
    ...
    const temp_axis_2d = parse_as_Union_of_Literal_of__quote_x_quote_0_quote_y_quote_0_quote_z_quote__endof_0None_endof_(valueObject.axis_2d)
    if(temp_axis_2d instanceof Error){ return temp_axis_2d; }
    const temp_class_name = parse_as_Literal_of__quote_GaussianSmoothing_quote_0_quote_LaplacianofGaussian_quote_0_quote_GaussianGradientMagnitude_quote_0_quote_DifferenceofGaussians_quote_0_quote_StructureTensorEigenvalues_quote_0_quote_HessianofGaussianEigenvalues_quote__endof_(valueObject.class_name)
...
export class IlpFeatureExtractorDto {
    ...
    public class_name: 'Gaussian Smoothing' | 'Laplacian of Gaussian' | 'Gaussian Gradient Magnitude' | 'Difference of Gaussians' | 'Structure Tensor Eigenvalues' | 'Hessian of Gaussian Eigenvalues';
    constructor(params: {
        ilp_scale: number,
        axis_2d: 'x' | 'y' | 'z' | undefined,
        class_name: 'Gaussian Smoothing' | 'Laplacian of Gaussian' | 'Gaussian Gradient Magnitude' | 'Difference of Gaussians' | 'Structure Tensor Eigenvalues' | 'Hessian of Gaussian Eigenvalues',
    }) {
...
function parse_as_Tuple_of_IlpFeatureExtractorDto0_varlen__endof_(value: JsonValue): Array<IlpFeatureExtractorDto> | Error{
    const arr = ensureJsonArray(value);
    if(arr instanceof Error){    return arr
    }
...
function parse_as_FeatureSelectionAppletStateDto(value: JsonValue): FeatureSelectionAppletStateDto | Error{
    ...
    const temp_feature_extractors = parse_as_Tuple_of_IlpFeatureExtractorDto0_varlen__endof_(valueObject.feature_extractors)
...
export class FeatureSelectionAppletStateDto {
    ...
    constructor(params: {
        ...
        this.feature_extractors = params.feature_extractors;
    }
    public toJsonValue(): JsonObject{
        return {
...
function parse_as_Literal_of__quote_BOOT_FAIL_quote_0_quote_CANCELLED_quote_0_quote_COMPLETED_quote_0_quote_DEADLINE_quote_0_quote_FAILED_quote_0_quote_NODE_FAIL_quote_0_quote_OUT_OF_MEMORY_quote_0_quote_PENDING_quote_0_quote_PREEMPTED_quote_0_quote_RUNNING_quote_0_quote_REQUEUED_quote_0_quote_RESIZING_quote_0_quote_REVOKED_quote_0_quote_SUSPENDED_quote_0_quote_TIMEOUT_quote__endof_(value: JsonValue): 'BOOT_FAIL' | 'CANCELLED' | 'COMPLETED' | 'DEADLINE' | 'FAILED' | 'NODE_FAIL' | 'OUT_OF_MEMORY' | 'PENDING' | 'PREEMPTED' | 'RUNNING' | 'REQUEUED' | 'RESIZING' | 'REVOKED' | 'SUSPENDED' | 'TIMEOUT' | Error{
    ...
    return Error(`Could not parse ${value} as 'BOOT_FAIL' | 'CANCELLED' | 'COMPLETED' | 'DEADLINE' | 'FAILED' | 'NODE_FAIL' | 'OUT_OF_MEMORY' | 'PENDING' | 'PREEMPTED' | 'RUNNING' | 'REQUEUED' | 'RESIZING' | 'REVOKED' | 'SUSPENDED' | 'TIMEOUT'`)
}
function parse_as_ComputeSessionDto(value: JsonValue): ComputeSessionDto | Error{
    ...
    const temp_state = parse_as_Literal_of__quote_BOOT_FAIL_quote_0_quote_CANCELLED_quote_0_quote_COMPLETED_quote_0_quote_DEADLINE_quote_0_quote_FAILED_quote_0_quote_NODE_FAIL_quote_0_quote_OUT_OF_MEMORY_quote_0_quote_PENDING_quote_0_quote_PREEMPTED_quote_0_quote_RUNNING_quote_0_quote_REQUEUED_quote_0_quote_RESIZING_quote_0_quote_REVOKED_quote_0_quote_SUSPENDED_quote_0_quote_TIMEOUT_quote__endof_(valueObject.state)
...
export class ComputeSessionDto {
    ...
    public state: 'BOOT_FAIL' | 'CANCELLED' | 'COMPLETED' | 'DEADLINE' | 'FAILED' | 'NODE_FAIL' | 'OUT_OF_MEMORY' | 'PENDING' | 'PREEMPTED' | 'RUNNING' | 'REQUEUED' | 'RESIZING' | 'REVOKED' | 'SUSPENDED' | 'TIMEOUT';
    constructor(params: {
        ...
        state: 'BOOT_FAIL' | 'CANCELLED' | 'COMPLETED' | 'DEADLINE' | 'FAILED' | 'NODE_FAIL' | 'OUT_OF_MEMORY' | 'PENDING' | 'PREEMPTED' | 'RUNNING' | 'REQUEUED' | 'RESIZING' | 'REVOKED' | 'SUSPENDED' | 'TIMEOUT',
    }) {
        ...
        this.compute_session_id = params.compute_session_id;
...
function parse_as_Literal_of__quote_LOCAL_quote_0_quote_CSCS_quote_0_quote_JUSUF_quote__endof_(value: JsonValue): 'LOCAL' | 'CSCS' | 'JUSUF' | Error{
    const tmp_0 = parse_as_str(value)
...
function parse_as_ComputeSessionStatusDto(value: JsonValue): ComputeSessionStatusDto | Error{
    ...
    const temp_hpc_site = parse_as_Literal_of__quote_LOCAL_quote_0_quote_CSCS_quote_0_quote_JUSUF_quote__endof_(valueObject.hpc_site)
...
export class ComputeSessionStatusDto {
    ...
    constructor(params: {
        ...
        this.compute_session = params.compute_session;
...
export class CreateComputeSessionParamsDto {
    ...
    constructor(params: {
        ...
        this.session_duration_minutes = params.session_duration_minutes;
        this.hpc_site = params.hpc_site;
    }
    public toJsonValue(): JsonObject{
        return {
...
function parse_as_Tuple_of_ComputeSessionStatusDto0_varlen__endof_(value: JsonValue): Array<ComputeSessionStatusDto> | Error{
    const arr = ensureJsonArray(value);
    if(arr instanceof Error){    return arr
    }
...
function parse_as_ListComputeSessionsResponseDto(value: JsonValue): ListComputeSessionsResponseDto | Error{
    ...
    const temp_compute_sessions_stati = parse_as_Tuple_of_ComputeSessionStatusDto0_varlen__endof_(valueObject.compute_sessions_stati)
...
export class ListComputeSessionsResponseDto {
    ...
    constructor(params: {
        ...
        this.compute_sessions_stati = params.compute_sessions_stati;
    }
    public toJsonValue(): JsonObject{
        return {
...
function parse_as_Tuple_of_Literal_of__quote_LOCAL_quote_0_quote_CSCS_quote_0_quote_JUSUF_quote__endof_0_varlen__endof_(value: JsonValue): Array<'LOCAL' | 'CSCS' | 'JUSUF'> | Error{
    const arr = ensureJsonArray(value);
    if(arr instanceof Error){    return arr
    }
...
function parse_as_GetAvailableHpcSitesResponseDto(value: JsonValue): GetAvailableHpcSitesResponseDto | Error{
    ...
    const temp_available_sites = parse_as_Tuple_of_Literal_of__quote_LOCAL_quote_0_quote_CSCS_quote_0_quote_JUSUF_quote__endof_0_varlen__endof_(valueObject.available_sites)
...
export class GetAvailableHpcSitesResponseDto {
    ...
    constructor(params: {
        ...
        this.available_sites = params.available_sites;
    }
    public toJsonValue(): JsonObject{
        return {
...
function parse_as_StartPixelProbabilitiesExportJobParamsDto(value: JsonValue): StartPixelProbabilitiesExportJobParamsDto | Error{
    const valueObject = ensureJsonObject(value);
    if(valueObject instanceof Error){
        return valueObject;
    }
...
function parse_as_StartSimpleSegmentationExportJobParamsDto(value: JsonValue): StartSimpleSegmentationExportJobParamsDto | Error{
    const valueObject = ensureJsonObject(value);
    if(valueObject instanceof Error){
        return valueObject;
    }
...
export class StartSimpleSegmentationExportJobParamsDto {
    ...
    constructor(params: {
        ...
        this.datasource = params.datasource;
        this.datasink = params.datasink;
        this.label_header = params.label_header;
    }
    public toJsonValue(): JsonObject{
        return {
            datasource: this.datasource.toJsonValue(),
...
export class LoadProjectParamsDto {
    ...
    constructor(params: {
        ...
        this.fs = params.fs;
        this.project_file_path = params.project_file_path;
    }
    public toJsonValue(): JsonObject{
        return {

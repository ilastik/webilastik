...
class File(Group):
    ...
    def __init__(self, name: "str | bytes | BytesIO | os.PathLike", mode=..., driver=..., libver=..., userblock_size=..., swmr=..., rdcc_nslots=..., rdcc_nbytes=..., rdcc_w0=..., track_order=..., fs_strategy=..., fs_persist=..., fs_threshold=..., fs_page_size=..., page_buf_size=..., min_meta_keep=..., min_raw_keep=..., locking=..., **kwds) -> None:

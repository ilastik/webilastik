...
class Group(HLObject, MutableMappingHDF5):
    ...
    _gcpl_crt_order = ...
    def create_group(self, name, track_order: Optional[Any] = ...):
    ...
    def create_dataset(self, name, shape: Optional[Any] = ..., dtype: Optional[Any] = ..., data: Optional[Any] = ..., **kwds):
    ...
    if vds_support:
        def create_virtual_dataset(self, name, layout, fillvalue: Optional[Any] = ...):
    ...
    def get(self, name, default: Optional[Any] = ..., getclass: bool = ..., getlink: bool = ...):
    ...
    def copy(self, source, dest, name: Optional[Any] = ..., shallow: bool = ..., expand_soft: bool = ..., expand_external: bool = ..., expand_refs: bool = ..., without_attrs: bool = ...):

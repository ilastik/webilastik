...
class AxisInfo(Boost.Python.instance):
    @classmethod
...
class AxisTags(Boost.Python.instance):
    __reduce__: Any = ...
    @classmethod
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    ...
    def toFrequencyDomain(self, *args, **kwargs) -> Any: ...
    @classmethod
    def toJSON(self, *args, **kwargs) -> Any: ...
    @classmethod
...
class AxisType(Boost.Python.enum):
    AllAxes: Any = ...
    Angle: Any = ...
    Channels: Any = ...
    Edge: Any = ...
...
class ChunkedArrayBase(Boost.Python.instance):
    @classmethod
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
...
class Compression(Boost.Python.enum):
    LZ4: Any = ...
    ZLIB: Any = ...
    ZLIB_BEST: Any = ...
    ZLIB_FAST: Any = ...
...
class HDF5Mode(Boost.Python.enum):
    Default: Any = ...
    New: Any = ...
    ReadOnly: Any = ...
    ReadWrite: Any = ...
